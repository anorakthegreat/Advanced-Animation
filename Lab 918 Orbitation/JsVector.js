...
// JSVector.getRandomNumber = function(arr) {
//   const random = Math.random();
//   const scaledRandom = random * (arr[1] - arr[0] + 1) + arr[0];
//   const randomNumber = Math.floor(scaledRandom);

//   if(randomNumber == 0){
//     return this.getRandomNumber(arr[1], arr[0])
//   }else{
//     return randomNumber;
...
JSVector.getDistance = function(v1, v2){
  xVal = Math.pow(v2.x - v1.x, 2)
  yVal = Math.pow(v2.y - v1.y, 2)
